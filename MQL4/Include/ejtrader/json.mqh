...
// 2018.02.19 Fixes by Ding Li (dingmaotu@hotmail.com):
// 1. empty array handling
// 2. StringConcatenate use (instead of MQL5 StringConcatenate(str_var, arg1, arg2),
//    MQL4 uses string str_var = StringConcatenate(arg1, arg2))
...
public:
   ...
   string toString()
     {
      return StringConcatenate("\"",_string,"\"");
     }
  };
// -----------------------------------------
   ...
   JSONArray *parseArray()
     {
      ...
      if(expect('['))
        {
         //--- either empty array or a list of values are expected
         skipSpace();
         if(!expectOptional(']'))
           {
            while(_errCode==0)
